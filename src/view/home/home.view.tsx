  ...
  const renderHeader = () => (
    <View className="w-full">
      ...
      <View className="bg-[#241e3a] p-5 rounded-2xl flex-row items-center justify-between mb-6 border border-[#2e264a]">
        ...
        <View className={`w-[72px] h-[72px] rounded-full border-[6px] items-center justify-center ml-4 ${completionPercentage === 100 ? 'border-[#8e84f5]' : completionPercentage === 0 ? 'border-[#3f346b]' : completionPercentage > 50 ? 'border-[#3f346b] border-t-[#8e84f5]' : 'border-[#3f346b] border-t-[#8e84f5]'}`}>
